...
StateOfExampleGameMenu::StateOfExampleGameMenu(HRDR hrdr, std::shared_ptr<TextureManager> texture_manager)
: hrdr(hrdr), texture_manager(texture_manager) {
  std::cout << "StateOfExampleGameMenu" << std::endl;
}

StateOfExampleGameMenu::~StateOfExampleGameMenu() {
  std::cout << "~StateOfExampleGameMenu" << std::endl;
}

void StateOfExampleGameMenu::load() {
...
void StateOfExampleGameMenu::handle_event(SDL_Event& event, StateManager& state_manager) {
  switch (event.type) {
    case SDL_KEYDOWN:
      {
        switch (event.key.keysym.sym) {
          case SDLK_ESCAPE:
            {
              state_manager.edit_state("examplegamemenu", {
                .need_to_fuse = true,
              });
...
void StateOfExampleGameMenu::update() {
}

void StateOfExampleGameMenu::render() {
...
void StateOfExampleGameMenu::unload() {
  std::cout << "StateOfExampleGameMenu unload()" << std::endl;
}
